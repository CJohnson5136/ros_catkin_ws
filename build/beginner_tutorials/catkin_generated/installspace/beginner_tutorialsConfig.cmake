...
if(NOT "include " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/beginner_tutorials " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Cody Johnson <cody.johnson@ucollege.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/install/${idir}'.  ${_report}")
    endif()
